            ...
            <div class="card-body">
                <form action="${pageContext.request.contextPath}/associations/associate" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Only available donors are listed</small>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Only waiting recipients are listed</small>
                    </div>

                    <!-- Alert Info -->
                    <div class="alert alert-info">
                        <strong>ℹ️ Info:</strong> The system automatically checks blood compatibility before the association.
                    </div>
